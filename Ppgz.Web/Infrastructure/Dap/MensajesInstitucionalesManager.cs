...
using Ppgz.Services;
using Ppgz.Web.Areas.Dap;

namespace Ppgz.Web.Infrastructure.Dap
{
    public class MensajesInstitucionalesManager
    {
        ...
        public List<cuentasmensajes> FindCuentaMensajes(int cuentaId)
        {
        ...
        public void Visualizar(int cuentaId, int mensajeId, string usuarioId)
        {
            ...
            var cuentaMensaje = new cuentasmensajes()
            {
                CuentaId = cuentaId,
                MensajeId = mensajeId,
