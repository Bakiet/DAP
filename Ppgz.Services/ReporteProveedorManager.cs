...
namespace Ppgz.Services
{
    ...
    {/*
           ...
           decimal acumuladoAnual, decimal pedidoAtrasado, decimal pedidoEntiempo, decimal pedidoTotal)
        {
            ...
            var nivelServicio = _db.niveleseervicio.FirstOrDefault(n => n.ProveedorId == proveedor.Id);
            ...
            if (nivelServicio == null)
            {
                ...
                _db.niveleseervicio.Add(nivelServicio);
            }
            else
            {
        ...
        public niveleseervicio FindNivelSerNiveleseervicio(int proveedorId)
        {
           ...
           return _db.niveleseervicio.FirstOrDefault(n => n.ProveedorId == proveedor.Id);
            
        }

        public niveleseervicio LastNivleServicio()
        {
            return _db.niveleseervicio.OrderBy(n=> n.Fecha).FirstOrDefault();
        }
        */
    }
}
